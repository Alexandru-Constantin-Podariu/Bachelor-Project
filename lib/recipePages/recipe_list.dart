...
class RecipeList extends StatefulWidget {
  ...
  final Function(Recipe) onCheckRecipeClick;
  ...
  RecipeList({
    ...
    required this.onCheckRecipeClick,
  });
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return RecipeListItem(
                ...
                onCheckRecipeClick: widget.onCheckRecipeClick,
              );
            },
          ),
        ),
          ...
          Row(
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: () => onCheckRecipeClick(recipe),
              ),
              const SizedBox(width: 125),
              IconButton(
